...
public class CamundaGaTaskWaPermissionTest extends DmnDecisionTableBaseUnitTest {
    ...
    @SuppressWarnings("checkstyle:indentation")
    @Test
    void given_receivePaymentForApplication_taskType_when_evaluate_dmn_then_it_returns_expected_rule() {
        VariableMap inputVariables = new VariableMapImpl();
        inputVariables.putValue("taskAttributes", Map.of("taskType", "ReceivePaymentForApplication"));
