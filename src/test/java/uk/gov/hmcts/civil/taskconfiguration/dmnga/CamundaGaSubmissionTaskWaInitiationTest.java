...
public class CamundaGaSubmissionTaskWaInitiationTest extends DmnDecisionTableBaseUnitTest {
    ...
    @Test
    void when_unlessOrder_deadline_ends_taskId_then_return_making_work_review_applicationOrder_withSdo() {
    ...
    @Test
    void when_unlessOrder_deadline_ends_taskId_then_return_making_work_review_applicationOrder_withOutSdo() {
