...
# urls
echo "export SERVICE_AUTH_PROVIDER_API_BASE_URL=http://rpe-service-auth-provider-aat.aat.platform.hmcts.net"
...
echo "export CAMUNDA_BASE_URL=https://camunda-civil-task-configuration-pr-${pr}.spreview.platform.hmcts.net"
